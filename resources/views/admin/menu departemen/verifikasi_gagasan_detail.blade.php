...
@section('breadcrumb')
    <span class="breadcrumb-item"><i class="fas fa-building"></i>   Menu Departemen</span>
    <a class="breadcrumb-item" href="/verifikasi-departemen">Verifikasi Usulan Gagasan</a>
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Tindak Lanjut dari Departemen Terkait</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-6">
