...
@section('breadcrumb')
    ...
    <a class="breadcrumb-item" href="/approval-plan-action">Verifikasi Plan Action Inovasi</a>
        ...
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="card-toolbar">
                    <a href="/detail-approval-gagasan" class="btn btn-warning btn-tone m-r-5"><i class="fas fa-eye"></i>  Detail Gagasan</a>
