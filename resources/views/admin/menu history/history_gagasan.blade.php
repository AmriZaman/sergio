...
@section('breadcrumb')
    <span class="breadcrumb-item"><i class="fas fa-clock"></i>   Menu History</span>
    <span class="breadcrumb-item" active>History Approval Gagasan</span>
            ...
            <table id="data-table" class="table table-responsive" style="width:100%">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="row">
                                <a class="m-b-10 m-l-10" href="/detail-approval-gagasan">
