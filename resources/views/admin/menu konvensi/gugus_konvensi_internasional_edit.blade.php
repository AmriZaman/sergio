...
<span class="breadcrumb-item" active>Edit Gugus Konvensi Internasional</span>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <h4 class="card-title">Edit Gugus Konvensi Internasional</h4>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="m-t-20 m-b-10" style="width: 100%">
                    <input type="text" class="form-control" placeholder="Tulis Keterangan Prestasi / Juara (Cth: Juara 1 Kategori Presentasi Terbaik)">
                </div>
