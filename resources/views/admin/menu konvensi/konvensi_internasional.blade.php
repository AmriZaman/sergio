...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item" active>Konvensi Internasional</span>
...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Tambah Gugus Konvensi Internasional</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-9">
                    <div class="row">
                        <div class="m-b-15 col-md-12">
                            <select class="select2" name="state">
                                ...
                                <option value="NL">Konvensi 1 - Internasional</option>
                                <option value="BN">Konvensi 2 - Internasional</option>
                            </select>
                        </div>
                    </div>
                </div> 
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <h4 class="card-title">Daftar Gugus Konvensi Internasional</h4>
                ...
                <table id="data-table" class="table table-bordered" style="width:100%">
                    ...
                    <tbody>
                        <tr class="">
                            ...
                            <td>
                                <div class="row">
                                    <a class="m-b-10 m-l-10" href="/detail-gugus-konvensi-internasional">
                                    ...
                                    <a class="m-b-10 m-l-10" href="/edit-gugus-konvensi-internasional">
