...
<a class="breadcrumb-item" href="/rekap-konvensi">Rekap Konvensi</a>
<span class="breadcrumb-item" active>Detail Gugus Konvensi Nasional</span>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <h4 class="card-title">Detail Gugus Konvensi Nasional</h4>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="card-body">
                ...
                <input type="text" class="form-control m-b-10" id="formGroupExampleInput" placeholder="Contoh: Diamond; Presentasi Terbaik; dll" value="Diamond" disabled>

                <div class="m-t-40">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="/rekap-konvensi">
                                <button class="btn btn-warning btn-block btn-tone">Kembali</button>
                            </a>
                        </div>
                    </div>
                </div>
