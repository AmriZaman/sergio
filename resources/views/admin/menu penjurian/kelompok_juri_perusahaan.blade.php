...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item" active>Kelompok Juri TK Perusahaan</span>
...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Buat Kelompok Juri Perusahaan</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="m-b-15 col-md-4">
                                    <select class="select2" name="state">
                                        <option value="AP">Pilih Koordinator</option>
                                        <option value="NL">Nails</option>
                                        <option value="BN">Bananas</option>
                                        <option value="HL">Helicopters</option>
                                    </select>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Daftar Kelompok Juri Perusahaan</h4>
        </div>
        <div class="card-body">
