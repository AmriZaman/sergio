...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item" active>Pembagian Gugus Tingkat Kompartemen</span>
...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Pembagian Gugus pada Kelompok Juri Tingkat Kompartemen</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
