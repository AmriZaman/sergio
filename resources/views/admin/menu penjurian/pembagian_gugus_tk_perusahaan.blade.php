...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item" active>Pembagian Gugus Tingkat Perusahaan</span>
...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Pembagian Gugus pada Kelompok Juri Tingkat Perusahaan</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        <div class="m-b-15 col-md-8">
                        ...
                        <div class="m-b-15 col-md-2">
                            <button type="button" class="btn btn-success m-r-5 col-md-12" data-toggle="tooltip" data-placement="bottom" title="Generate Pembagian"><i class="anticon anticon-plus"></i> Generate</button>
                        </div>
                        <div class="m-b-30 col-md-2">
                            <button type="button" class="btn btn-danger m-r-5 col-md-12" data-toggle="tooltip" data-placement="bottom" title="Hapus Pembagian"><i class="anticon anticon-delete"></i> Hapus</button>
                        </div>
                    </div>
                </div> 
            </div>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <div class="d-flex align-items-center justify-content-between">
                <h4 class="card-title">Kelompok 1</h4>
