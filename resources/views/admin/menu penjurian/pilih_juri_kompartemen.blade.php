...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item" active>Pilih Juri Kompartemen</span>
...
@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Inisiasi Juri Kompartemen</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title h4">Kelola Juri Kompartemen</h5>
