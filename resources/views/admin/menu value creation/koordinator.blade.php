...
@section('breadcrumb')
    ...
    <span class="breadcrumb-item" active>Pemilihan Koordinator Value Creation</span>
@endsection

@section('content')
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Pilih Koordinator Value Creation</h4>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="m-b-30 col-md-2">
                            <button type="button" class="btn btn-success m-r-5 col-md-12" data-toggle="modal" data-target=".pilih-koordinator">Pilih Koordinator</button>
                            {{-- Modal --}}
                            <div class="modal fade pilih-koordinator">
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title h4">Kelola Koordinator Juri Perusahaan</h5>
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h4 class="card-title">Daftar Koordinator Juri Perusahaan</h4>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="text-center font-size-150">
                                                        ...
                                                        <p class="text-dark font-size-16 m-b-40">Apakah anda yakin menghapus Koordinator?</p>
                                                    </div>
